...
run_chroot apt-get -yy purge --remove casper lupin-casper kwalletmanager plasma-discover xpra acl apt-transport-https aspell aspell-en at-spi2-core build-essential colord colord-data cups-browsed dpkg-dev enchant fakeroot fonts-droid-fallback fonts-dreefont-ttf fonts-lato fonts-noto fonts-noto-cjk fonts-noto-hinted fonts-noto-mono fonts-noto-unhinted gconf2-common gdbserver geoclue-2.0 gnome-terminal gnome-terminal-data gpnug2 gsfonts gstreamer1.0-gl gvfs gvfs-common gvfs-daemons gvfs-libs i965-va-driver iio-sensor-proxy imagemagick imagemagick-6-common imagemagick-6.q16 ippusbxd iputils-arping javascript-common kactivities-bin kamera kgamma5 kpackagelauncherqml kwayland-integration kwrited media-player-info mysql-common nautilus-extension-gnome-terminal netpbm network-manager-pptp networkd-dispatcher nodejs nodejs-doc notification-daemon openresolv patch ppp pptp-linux qml-module-org-kde-newstuff qml-module-org-kde-runnermodel qt-at-spi qt5-gtk-platformtheme qtdeclarative5-qtquick2-plugin qtwayland5 rake rtkit ruby ruby-did-you-mean ruby-minitest ruby-net-telnet ruby-power-assert ruby-test-unit ruby2.5 rubygems-integration sane-utils sddm-theme-breeze sni-qt sonnet-plugins va-driver-all vbetool vdpau-driver-all vlc-plugin-samba vlc-plugin-skins2 vlc-plugin-notify vlc-plugin-video-splitter vlc-plugin-visualization wireless-tools xfonts-scalable xserver-xorg-input-wacom xserver-xorg-legacy xserver-xorg-video-all xserver-xorg-video-ati xserver-xorg-video-qxl yelp yelp-xsl
